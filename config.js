...
// without touching page logic. Loaded as an ES module by order.html and
// OrdersView.html.
...
export const WEBMITRA_CONFIG = {
  ...
  // Auto-redirect to WhatsApp after a successful order save.
  whatsapp: {
    enabled: true,
    openInNewTab: true,
    redirectDelayMs: 600,
    // Tokens: {name} {email} {phone} {websiteType} {budget} {deadline} {description} {key}
    messageTemplate:
